...
2. conda 가상환경 설정하기
  - conda 가상 환경 생성: `conda create -n new_env_name python=3.10.14`
  - conda 가상 환경 활성화: `conda activate new_env_name`

3. 필요 패키지 설치 <br>
  `pip install -r requirements.txt`

### 실험 시작
1. `stablediffusion.py` 실행
2. 양자화 실험 <br>
  - 단일 임곗값 설정 실험: `python3 whold_threshold.py`
